...
# Script para ejecutar Query Control - AGING_1
# Prioridad: 4
...
echo -e "${CYAN}            AGING_1 - PRIORIDAD 4       ${NC}"
echo -e "${BLUE}=========================================${NC}"
...
echo -e "\n${GREEN}🚀 Iniciando Query Control - AGING_1...${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
if [ $exit_code -eq 0 ]; then
    echo -e "${GREEN}✅ Query Control AGING_1 ejecutado correctamente${NC}"
else
    echo -e "${RED}❌ Query Control AGING_1 terminó con error (código: $exit_code)${NC}"
fi

echo -e "\n${BLUE}=========================================${NC}"
echo -e "${CYAN}     QUERY CONTROL AGING_1 FINALIZADO  ${NC}"
echo -e "${BLUE}=========================================${NC}"
