...
# Script para ejecutar Query Control - AGING_2
# Prioridad: 3
...
echo -e "${CYAN}            AGING_2 - PRIORIDAD 3       ${NC}"
echo -e "${BLUE}=========================================${NC}"
...
echo -e "\n${GREEN}🚀 Iniciando Query Control - AGING_2...${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
if [ $exit_code -eq 0 ]; then
    echo -e "${GREEN}✅ Query Control AGING_2 ejecutado correctamente${NC}"
else
    echo -e "${RED}❌ Query Control AGING_2 terminó con error (código: $exit_code)${NC}"
fi

echo -e "\n${BLUE}=========================================${NC}"
echo -e "${CYAN}     QUERY CONTROL AGING_2 FINALIZADO  ${NC}"
echo -e "${BLUE}=========================================${NC}"
