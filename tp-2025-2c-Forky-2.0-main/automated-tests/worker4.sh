...
# Script para ejecutar Worker 4
# Parámetros: Worker4.config, Worker ID 004
...
echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}         EJECUTANDO WORKER 4            ${NC}"
echo -e "${BLUE}=========================================${NC}"
...
if [ $exit_code -eq 0 ]; then
    echo -e "${GREEN}✅ Worker 4 terminó correctamente${NC}"
else
    echo -e "${RED}❌ Worker 4 terminó con error ($exit_code)${NC}"
fi

echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}      WORKER 4 FINALIZADO               ${NC}"
echo -e "${BLUE}=========================================${NC}"
exit $exit_code
