...
# =============================================================================
# TEST STORAGE_1 - Query Control 1
# SCRIPT=STORAGE_1, PRIORIDAD=0
# =============================================================================
...
SCRIPT_NAME="STORAGE_1"
PRIORIDAD=0

echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}    TEST STORAGE_1 - Query Control 1    ${NC}"
echo -e "${BLUE}=========================================${NC}"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "${GREEN}✅ Query Control 1 (${SCRIPT_NAME}) finalizado exitosamente${NC}"
else
    echo -e "${RED}❌ Query Control 1 (${SCRIPT_NAME}) finalizó con errores (código: $EXIT_CODE)${NC}"
fi
echo -e "${BLUE}=========================================${NC}"
