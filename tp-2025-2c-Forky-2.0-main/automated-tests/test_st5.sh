...
# =============================================================================
# TEST STORAGE_1 - Query Control 5 (VALIDACIÓN FINAL)
# SCRIPT=STORAGE_5, PRIORIDAD=0
# Se ejecuta después de validar el estado del FS
# =============================================================================
...
SCRIPT_NAME="STORAGE_5"
PRIORIDAD=0

echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}    TEST STORAGE_1 - Query Control 5    ${NC}"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "${GREEN}✅ Query Control 5 (${SCRIPT_NAME}) finalizado exitosamente${NC}"
else
    echo -e "${RED}❌ Query Control 5 (${SCRIPT_NAME}) finalizó con errores (código: $EXIT_CODE)${NC}"
fi
echo -e "${BLUE}=========================================${NC}"
