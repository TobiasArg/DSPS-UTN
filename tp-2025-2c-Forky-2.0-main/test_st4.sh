...
# =============================================================================
# TEST STORAGE_1 - Query Control 4
# SCRIPT=STORAGE_4, PRIORIDAD=6
# =============================================================================
...
SCRIPT_NAME="STORAGE_4"
PRIORIDAD=6

echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}    TEST STORAGE_1 - Query Control 4    ${NC}"
echo -e "${BLUE}=========================================${NC}"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "${GREEN}✅ Query Control 4 (${SCRIPT_NAME}) finalizado exitosamente${NC}"
else
    echo -e "${RED}❌ Query Control 4 (${SCRIPT_NAME}) finalizó con errores (código: $EXIT_CODE)${NC}"
fi
echo -e "${BLUE}=========================================${NC}"
