...
# Script para ejecutar Query Control - AGING_3
# Prioridad: 5
...
echo -e "${BLUE}=========================================${NC}"
echo -e "${CYAN}       EJECUTANDO QUERY CONTROL        ${NC}"
echo -e "${CYAN}            AGING_3 - PRIORIDAD 5       ${NC}"
echo -e "${BLUE}=========================================${NC}"
...
echo -e "\n${GREEN}🚀 Iniciando Query Control - AGING_3...${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
if [ $exit_code -eq 0 ]; then
    echo -e "${GREEN}✅ Query Control AGING_3 ejecutado correctamente${NC}"
else
    echo -e "${RED}❌ Query Control AGING_3 terminó con error (código: $exit_code)${NC}"
fi

echo -e "\n${BLUE}=========================================${NC}"
echo -e "${CYAN}     QUERY CONTROL AGING_3 FINALIZADO  ${NC}"
echo -e "${BLUE}=========================================${NC}"
